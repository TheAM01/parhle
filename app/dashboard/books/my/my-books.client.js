    ...
    useEffect(() => {
        ...
        async function fetchData() {
            ...
            try {
                ...
                const response = await fetch(`/api/book/user/${user.username}`);
        ...
        <div className={"w-screen bg-black flex-row text-white min-h-screen pt-8 lg:pt-0 texture-mosaic"}>
            ...
            <div className="w-full h-screen overflow-y-scroll">
                ...
                <div className="flex-col w-full md:w-4/5 lg:w-3/5 p-4 lg:p-10 mx-auto">
                    ...
                    <div className="font-bold text-4xl mb-5">My Books</div>
                    <div className="text-sm text-gray-dark mb-5 md:mb-10">Books shared by you</div>
