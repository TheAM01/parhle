        ...
        <div className={"w-screen bg-black flex-row text-white min-h-screen pt-8 lg:pt-0 texture-mosaic"}>
            ...
            <DashboardScrollable>
                <DashboardWorkspace>
                    <PageTitle
                        heading={"My Channels"}
                        description={"Channels shared by you"}
                    />
                    ...
                    <div className={`${loading ? "justify-center pt-10" : "grid! grid-cols-1 gap-6"} mt-2`}>
                        ...
                        >
                            ...
                            <HorizontalRule/>
                            <div className={"gap-2"}>
                                <Link href={`/dashboard/channels/edit/${note._id}`} className={"bg-white justify-center flex p-2 cursor-pointer flex-1 sm:flex-none sm:w-[100px] font-semibold text-sm text-gray-600 hover:text-black duration-100"}>Edit</Link>
